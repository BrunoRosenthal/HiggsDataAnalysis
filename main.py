    ...
    def create_hist(self):
        ...
        for num, ax, bin_size, title, range_size, mark in zip(range(1, 10), self.flattened_axes, self.bins, self.titles, self.ranges, self.tick_marks):
            if num == 9:
                ...
                heights, bins, patches = ax.hist(data_section, bins=bin_size, stacked=True, color=self.colors, label=self.labels, rwidth=0.8, range=range_size, weights=weight_section,
